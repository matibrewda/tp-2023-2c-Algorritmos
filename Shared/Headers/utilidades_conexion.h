...
int esperar_conexion_de_cliente(t_log* logger, char* puerto_proceso_servidor, int socket_servidor, const char* NOMBRE_MODULO_SERVIDOR, const char* nombre_cliente_a_escuchar);
