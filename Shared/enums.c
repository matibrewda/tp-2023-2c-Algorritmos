...
const char* nombre_opcode(op_code opcode)
{
    switch (opcode)
    {
        ...
        case RESPUESTA_ESCRIBIR_BLOQUE_EN_MEMORIA_FS: return "'RESPUESTA_ESCRIBIR_BLOQUE_EN_MEMORIA_FS'";
        case RESPUESTA_LEER_PAGINA_DE_MEMORIA_FS: return "'RESPUESTA_LEER_PAGINA_DE_MEMORIA_FS'";
