...
t_pedido_leer_valor_de_memoria *leer_paquete_solicitud_leer_valor_en_memoria(t_log *logger, int conexion_con_cpu)
{
	...
	log_debug(logger, "Comenzando la lectura del paquete de codigo de operacion %s y contenido 'PID + DIRECCION FISICA' (Origen: %s - Destino %s).", nombre_opcode(codigo_operacion), NOMBRE_MODULO_CPU, NOMBRE_MODULO_MEMORIA);
	...
	log_debug(logger, "Exito en la lectura del paquete de codigo de operacion %s y contenido 'PID + DIRECCION FISICA' (Origen: %s - Destino %s).", nombre_opcode(codigo_operacion), NOMBRE_MODULO_CPU, NOMBRE_MODULO_MEMORIA);
...
{
	op_code codigo_operacion = SOLICITUD_ESCRIBIR_VALOR_EN_MEMORIA;
	log_debug(logger, "Comenzando la lectura del paquete de codigo de operacion %s y contenido 'PID + DIRECCION FISICA + VALOR' (Origen: %s - Destino %s).", nombre_opcode(codigo_operacion), NOMBRE_MODULO_CPU, NOMBRE_MODULO_MEMORIA);
	...
	log_debug(logger, "Exito en la lectura del paquete de codigo de operacion %s y contenido 'PID + DIRECCION FISICA + VALOR' (Origen: %s - Destino %s).", nombre_opcode(codigo_operacion), NOMBRE_MODULO_CPU, NOMBRE_MODULO_MEMORIA);
...
void leer_paquete_solicitud_escribir_bloque_en_memoria(t_log *logger, int conexion_con_filesystem, int *direccion_fisica, void **contenido_bloque)
{
	...
	log_debug(logger, "Comenzando la lectura del paquete de codigo de operacion %s (Origen: %s - Destino %s).", nombre_opcode(codigo_operacion), NOMBRE_MODULO_FILESYSTEM, NOMBRE_MODULO_MEMORIA);
...
void leer_paquete_respuesta_leer_marco_de_memoria(t_log *logger, int conexion_con_memoria, void **contenido_marco, char **nombre_archivo, int *puntero_archivo)
{
	...
	log_debug(logger, "Comenzando la lectura del paquete de codigo de operacion %s y contenido 'CONTENIDO MARCO' (Origen: %s - Destino %s).", nombre_opcode(codigo_operacion), NOMBRE_MODULO_MEMORIA, NOMBRE_MODULO_FILESYSTEM);
	...
	log_debug(logger, "Exito en la lectura del paquete de codigo de operacion %s y contenido 'CONTENIDO MARCO' (Origen: %s - Destino %s).", nombre_opcode(codigo_operacion), NOMBRE_MODULO_MEMORIA, NOMBRE_MODULO_FILESYSTEM);
}
...
t_list *leer_paquete_solicitud_liberar_bloques_de_fs(t_log *logger, int conexion_con_memoria)
{
	...
	log_debug(logger, "Comenzando la lectura del paquete de codigo de operacion %s y contenido 'NUMEROS DE BLOQUES' (Origen: %s - Destino %s).", nombre_opcode(codigo_operacion), NOMBRE_MODULO_MEMORIA, NOMBRE_MODULO_FILESYSTEM);
	...
	log_debug(logger, "Exito en la lectura del paquete de codigo de operacion %s y contenido 'NUMEROS DE BLOQUES' (Origen: %s - Destino %s).", nombre_opcode(codigo_operacion), NOMBRE_MODULO_MEMORIA, NOMBRE_MODULO_FILESYSTEM);
